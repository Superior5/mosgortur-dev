<template>
  <div>
    ...
    <div v-if="!toursStore.searchFullResult && !toursStore.noTours">
      <PagesNewMainSections11 />
      <PagesNewMainSections3 />
      <PagesNewMainSections4 />
      <PagesNewMainSections5 />
      <NewMainMosHolBanner class="md:mt-100px my-60px" />
      <PagesNewMainSections6 />
