<template>
  <div>
    <div v-if="toursStore.departureCities.length" @click="$emit('open')" class="input-value">
    ...
    <BlocksAutocomplete @select="changeParams" @close="$emit('close')" v-if="show" :items="toursStore.departureCities"
